...
const SiteDetailPage = () => {
    ...
    if (loading || !isComplete)
      return (
        <div className="text-white flex items-center justify-center h-screen w-full">
          <YoreLoader size={100} progress={progress} showProgress={true} />
        </div>
      );
    if (error)
        return (
    ...
    return (
      <div className="w-full min-h-screen flex flex-col items-center justify-start">
        ...
        <div className="bg-gradient-to-b from-yore-dark/50 to-white/10 from-20% backdrop-blur-2xl z-10 text-white shadow-2xl shadow-black rounded-xl flex flex-col gap-3 items-start p-5 lg:p-16 max-w-5xl lg:-mt-32 relative overflow-hidden">
            ...
            <div className="place-buttons absolute top-0 right-0">
              <Button.Group>
                <Button
                  color="gray"
                  href="/"
                  className="text-white bg-yore-explore rounded-tl-none rounded-br-none rounded-bl-xl rounded-tr-xl border-0 hover:bg-yore-explore/80"
                >
                  Back to map
                </Button>
              </Button.Group>
